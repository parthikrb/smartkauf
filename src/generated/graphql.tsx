...
export type ArticleManyWhereInput = {
  ...
  /** All values greater than the given value. */
  quantity_gt?: InputMaybe<Scalars['Float']>;
  /** All values greater than or equal the given value. */
  quantity_gte?: InputMaybe<Scalars['Float']>;
  /** All values that are contained in given list. */
  quantity_in?: InputMaybe<Array<Scalars['Float']>>;
  /** All values less than the given value. */
  quantity_lt?: InputMaybe<Scalars['Float']>;
  /** All values less than or equal the given value. */
  quantity_lte?: InputMaybe<Scalars['Float']>;
  /** All values that are not equal to given value. */
  quantity_not?: InputMaybe<Scalars['Float']>;
  /** All values that are not contained in given list. */
  quantity_not_in?: InputMaybe<Array<Scalars['Float']>>;
...
export type GetStoresQuery = {
  __typename?: 'Query';
  stores: Array<{ __typename?: 'Store'; id: string; name: string; location?: string | null }>;
};
...
export type GetStoreQuery = {
  __typename?: 'Query';
  store?: { __typename?: 'Store'; id: string; name: string; location?: string | null } | null;
};
...
export type CreateStoreMutation = {
  __typename?: 'Mutation';
  createStore?: { __typename?: 'Store'; id: string; name: string; location?: string | null } | null;
};
...
export type UpdateStoreMutation = {
  __typename?: 'Mutation';
  updateStore?: { __typename?: 'Store'; id: string; name: string; location?: string | null } | null;
};
...
export type DeleteStoreMutation = {
  __typename?: 'Mutation';
  deleteStore?: { __typename?: 'Store'; id: string; name: string } | null;
};
 ...
 * });
 */
export function useGetStoresQuery(
  baseOptions?: Apollo.QueryHookOptions<GetStoresQuery, GetStoresQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetStoresQuery, GetStoresQueryVariables>(GetStoresDocument, options);
}
export function useGetStoresLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetStoresQuery, GetStoresQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useGetStoreQuery(
  baseOptions: Apollo.QueryHookOptions<GetStoreQuery, GetStoreQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetStoreQuery, GetStoreQueryVariables>(GetStoreDocument, options);
}
export function useGetStoreLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetStoreQuery, GetStoreQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
`;
export type UpdateStoreMutationFn = Apollo.MutationFunction<
  UpdateStoreMutation,
...
export function useUpdateStoreMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<UpdateStoreMutation, UpdateStoreMutationVariables>(
    UpdateStoreDocument,
    options,
  );
}
...
export type UpdateStoreMutationOptions = Apollo.BaseMutationOptions<
  UpdateStoreMutation,
  UpdateStoreMutationVariables
>;
...
`;
export type DeleteStoreMutationFn = Apollo.MutationFunction<
  DeleteStoreMutation,
...
export function useDeleteStoreMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<DeleteStoreMutation, DeleteStoreMutationVariables>(
    DeleteStoreDocument,
    options,
  );
}
...
export type DeleteStoreMutationOptions = Apollo.BaseMutationOptions<
  DeleteStoreMutation,
  DeleteStoreMutationVariables
>;
